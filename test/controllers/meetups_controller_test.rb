...
class MeetupsControllerTest < ActionController::TestCase
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post :create, meetup: { disc: @meetup.disc, lat: @meetup.lat, long: @meetup.long, title: @meetup.title, user_id: @meetup.user_id }
    end
  ...
  test "should update meetup" do
    patch :update, id: @meetup, meetup: { disc: @meetup.disc, lat: @meetup.lat, long: @meetup.long, title: @meetup.title, user_id: @meetup.user_id }
    assert_redirected_to meetup_path(assigns(:meetup))
  end
